...
const (
	...
	TendermintHeaderValidateGas uint64 = 3000 // Gas for validate tendermint consensus state v1
	...
	TendermintLightBlockValidateGas uint64 = 3000 // Gas for validate tendermint consensus state v2
